 ...
 * 
 * Modified by Charles-Henri Hallard https://github.com/hallard/arduino-max31865
 * 
 * Modified by nurazur Copyright (c) 2024 
 *
...
private:
  void writeRegister8(uint8_t registr, uint8_t value);
  uint8_t readRegister8(uint8_t registr);
  /* Our configuration. */
  uint8_t  cs_pin;
  ptd_type type;
